...
In order to support loading of multiple wallets in directcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is directcoin.cpp.
...
Changes to directcoin.cpp
----------------------
directcoin.cpp is the entry point into directcoin-qt, and as such, will require some minor modifications to provide hooks for
