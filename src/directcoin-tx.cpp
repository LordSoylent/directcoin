...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DirectCoin Core directcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  directcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded directcoin transaction") + "\n" +
                               "  directcoin-tx [options] -create [commands]   " + _("Create hex-encoded directcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded directcoin transaction
