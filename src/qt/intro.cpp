...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DirectCoin Core"),
     ...
     * override -datadir in the directcoin.conf file in the default data directory
     * (to be consistent with directcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
