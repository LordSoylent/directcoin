                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DirectCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DirectCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and directcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DirectCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about DirectCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DirectCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DirectCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DirectCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a DirectCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DirectCoin Core help message to get a list with possible DirectCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DirectCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DirectCoin network", "", count));
}
...
{
    QString strTitle = tr("DirectCoin Core"); // default title
