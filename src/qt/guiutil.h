...
/** Utility functions used by the DirectCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render DirectCoin addresses in monospace font
...
// Parse "directcoin:" URI into recipient object, return true on successful parsing
