...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("DirectCoin Core");
	...
	QString copyrightTextXdrc = QChar(0xA9) + QString(tr(" 2018 The DirectCoin Core developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextXdrc);
