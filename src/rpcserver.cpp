...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DirectCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DirectCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DirectCoin features */
        {"directcoin", "masternode", &masternode, true, true, false},
        {"directcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"directcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"directcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"directcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"directcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"directcoin", "startmasternode", &startmasternode, true, true, false},
        {"directcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"directcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"directcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"directcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"directcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"directcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"directcoin", "mnbudget", &mnbudget, true, true, false},
        {"directcoin", "preparebudget", &preparebudget, true, true, false},
        {"directcoin", "submitbudget", &submitbudget, true, true, false},
        {"directcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"directcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"directcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"directcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"directcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"directcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"directcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"directcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"directcoin", "mnsync", &mnsync, true, true, false},
        {"directcoin", "spork", &spork, true, true, false},
        {"directcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"directcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use directcoind, or the -server option to directcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> directcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6616/\n";
}
